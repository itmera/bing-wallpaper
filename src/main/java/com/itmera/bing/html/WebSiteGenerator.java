...
import com.itmera.bing.BingFileUtils;
import com.itmera.bing.Images;
import com.itmera.bing.html.HtmlConstant.Head;
import com.itmera.bing.html.HtmlConstant.ImgCard;
import com.itmera.bing.html.HtmlConstant.MonthHistory;
import com.itmera.bing.html.HtmlConstant.Sidebar;
...
public class WebSiteGenerator {
    ...
    public String replaceMonthHistory(String html, Map<String, List<Images>> monthMap, String nowMonth) {
        ...
        for (String month : monthMap.keySet()) {
            ...
            if (month != null && month.equals(nowMonth)) {
                history = history.replace(MonthHistory.VAR_MONTH_HISTORY_MONTH_COLOR,
                        MonthHistory.VAR_MONTH_HISTORY_NOW_MONTH_COLOR);
            }
